...
// Fix: Using React.FC to properly handle React-specific props like 'key' in map functions, 
// as the TypeScript compiler sometimes requires explicit component typing for reserved props.
